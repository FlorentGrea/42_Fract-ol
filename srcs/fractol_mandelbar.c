...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/25 07:30:22 by fgrea             #+#    #+#             */
/*   Updated: 2017/03/25 22:44:27 by fgrea            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/fractol.h"

static void			*fractol_mandelbar2(void *d)
{
	t_pxl			*i;
	double			tmp;
...
t_pxl				*fractol_mandelbar(t_pxl *pxl)
{
	...
	while (++p <= 7)
	{
		...
		pthread_create(&c[p], NULL, fractol_mandelbar2, &i[p]);
	}
	while (p-- >= 0)
